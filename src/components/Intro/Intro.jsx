        ...
        <div className="intro__info">
          <Fade triggerOnce cascade damping={0.1}>
            ...
            <p className="intro__info--text">
              ...
              Javascript, ReactJS and web technologies. Enthusiastic, hardworking and innovative. I am driven by a relentless desire to learn and explore novel ideas. Presently located in the vibrant city of
